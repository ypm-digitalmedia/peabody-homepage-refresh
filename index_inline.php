        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-3 hidden-xs" style="text-align: right">
                    <img id="evolving_pic" src="http://sprout018.sprout.yale.edu/AM-testing/peabody-homepage-refresh/img/tower_drawing_crop_paleblue_large_test2.jpg" />

                </div>
                <div class="col-md-8 col-sm-9 col-xs-12" id="evolving_text">
                    <h2 class="blue-shadow">We're evolving!</h2>
                    <p class="blue-shadow" id="renoText">Visit <a href="http://peabodyevolved.yale.edu" title="Peabody Evolved" aria-label="Peabody Evolved">Peabody Evolved</a> to learn more about the Peabody’s transformative renovation.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row card-row">
            ...
            <div class="col-md-6">
                <div class="box-item box" id="card_event1">
                    <figure class="front photo-front photo-front-shadow-topbottom" style="background-image:url('http://sprout018.sprout.yale.edu/AM-testing/peabody-homepage-refresh/img/cards/events_exhibitions/king_philips_war_book_event_card-mini.jpg'); background-position: center;">
                        <div class="front-content">
                            <h2 class="box-header">King Philip's War Reconsidered</h2>
                            <h5 class="box-date box-date-right">Tuesday, February 20, 4:30 pm</h5>
                        </div>
                    </figure>
                    <figure class="back">
                        <div class="back-content">
                            <h5 class="box-header"><strong>Book Release and Discussion</strong></h5>
                            <h3 class="left plain-case mallory-thin exhibit-heading super-compress-h3" id="exhibit1_heading_back">King Philip's War Reconsidered</h3>
                            <!-- <h5 class="left plain-case mallory-mp-light exhibit-subheading compress-h5" id="exhibit1_subheading_back">Sub-heading</h5> -->
                            <hr />
                            <p>New books by scholars Lisa Brooks and Christine DeLucia provide dramatically different perspectives on King Philip’s War, one of the most devastating conflicts between Native Americans and European settlers.</p>
                            <p>Tuesday, February 20, 4:30 &ndash; 6:00 pm</p>
                            <p class="button-row"><a data-link-parent="card_event1" class="btn btn-peabody back-link" href="http://peabody.yale.edu/events/museum-talk/king-philips-war-reconsidered" role="button" title="More info: King Philip's War Reconsidered" aria-label="More info: King Philip's War Reconsidered">More Info</a></p>
                        </div>
                    </figure>
                </div>
            </div>
                ...
                <div class="box-item box" id="card_event1_alt">
                    <figure class="front photo-front photo-front-shadow-topbottom" style="background-image:url('http://sprout018.sprout.yale.edu/AM-testing/peabody-homepage-refresh/img/cards/events_exhibitions/gallery_talk_web_card_mini.jpg'); background-position: left;">
                        <div class="front-content">
                            ...
                            <h5 class="box-date box-date-right">NEXT: February 15, 2018</h5>
                        </div>
                    </figure>
                    <figure class="back">
                        <div class="back-content">
