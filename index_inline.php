		...
		<div class="row card-row">
				...
				<div class="box-item box" id="card_event1">
					<figure class="front photo-front photo-front-shadow-topbottom" style="background-image:url('http://sprout027.sprout.yale.edu/peabody-homepage-refresh/img/cards/events_exhibitions/Monters_Myths_Maniacs_webcard_2018-mini.jpg'); background-position: center;">
						<div class="front-content">
							...
							<h5 class="box-date box-date-right">October 26 &amp; 27, 2018</h5>
						</div>
					</figure>
					<figure class="back">
			...
			<div class="col-md-6">
				<div class="box-item box" id="card_event3">
					<figure class="front photo-front photo-front-shadow-topbottom" style="background-image:url('http://sprout027.sprout.yale.edu/peabody-homepage-refresh/img/cards/events_exhibitions/mineral_symposium_web_card-mini.jpg'); background-position: center;">
						<div class="front-content">
							<h2 class="box-header">Third Annual Yale Mineral &amp; Gem Symposium</h2>
							<h5 class="box-date box-date-right">October 19 &amp; 20, 2018</h5>
						</div>
					</figure>
					<figure class="back">
						<div class="back-content">
							<h5 class="box-header"><strong>Third Annual Yale Mineral &amp; Gem Symposium</strong></h5>
							<h3 class="left plain-case mallory-thin exhibit-heading super-compress-h3" id="exhibit3_heading_back">The Cultural and Scientific Value of Mineral Beauty</h3>
							<hr />
							<p>Engage with world-class specialists at our Annual Mineral &amp; Gem Symposium. Topics to be covered range from minerals in art objects to diamonds; and much more!</p>
							<p>Friday and Saturday, October 19 &amp; 20, 2018.</p>
							<p class="button-row"><a data-link-parent="card_event3" class="btn btn-peabody back-link" href="http://peabody.yale.edu/events/peabody-mineral-symposium" role="button" title="More info: Third Annual Yale Mineral & Gem Symposium" aria-label="More info: Third Annual Yale Mineral & Gem Symposium">Tickets &amp; Info</a></p>
						</div>
					</figure>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="box-item box" id="card_event4">
					<figure class="front photo-front photo-front-shadow-topbottom" style="background-image:url('http://sprout027.sprout.yale.edu/peabody-homepage-refresh/img/cards/events_exhibitions/Ostrom_John_Bockstoce_eventcard_Fall_2018-mini.jpg'); background-position: center;">
						<div class="front-content">
							<h2 class="box-header">Evening Lecture</h2>
							<h5 class="box-date box-date-right">Thursday, October 11, 2018</h5>
						</div>
					</figure>
					<figure class="back">
						<div class="back-content">
							<h5 class="box-header"><strong>Evening Lecture</strong></h5>
							<h3 class="left plain-case mallory-thin exhibit-heading super-compress-h3" id="exhibit4_heading_back">White Fox and Icy Seas in the Western Arctic</h3>
							<hr />
							<p>Join John R. Bockstoce, a leading scholar of the Arctic fur trade, for an illustrated discussion of its origin and evolution drawn from his 50 years of research and his books <em>Furs and Frontiers in the Far North</em> and <em>White Fox and Icy Seas in the Western Arctic</em>. Book signing to follow.</p>
							<p>Thursday, October 11 at 5:30 pm.</p>
							<p class="button-row"><a data-link-parent="card_event4" class="btn btn-peabody back-link" href="http://peabody.yale.edu/events/ostrom-talk/white-fox-and-icy-seas-western-arctic" role="button" title="More info: Ostrom Lecture with John R. Bockstoce" aria-label="More info: Ostrom Lecture with John R. Bockstoce">Tickets &amp; Info</a></p>
						</div>
					</figure>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="box-item box" id="card_event8">
					<figure class="front photo-front photo-front-shadow-topbottom" style="background-image:url('http://sprout027.sprout.yale.edu/peabody-homepage-refresh/img/cards/events_exhibitions/fiesta_latina_web_card_2018-09-13-mini.jpg'); background-position: left;">
						<div class="front-content">
							<h2 class="box-header">&iexcl;Fiesta Latina!</h2>
							<h5 class="box-date box-date-right">Saturday, October 13</h5>
						</div>
					</figure>
					<figure class="back">
						<div class="back-content">
							<h5 class="box-header"><strong>Public Program</strong></h5>
							<h3 class="left plain-case mallory-thin exhibit-heading" id="exhibit8_heading_back">&iexcl;Fiesta Latina!</h3>
							<h5 class="left plain-case mallory-mp-light exhibit-subheading" id="exhibit8_subheading_back">Free Admission / Entrada Gratis</h5>
							<hr />
							...
							<p>Saturday, October 13, 10 am &ndash; 4 pm</p>
							<p class="button-row"><a data-link-parent="card_event8" class="btn btn-peabody back-link" href="http://peabody.yale.edu/events/fiesta-latina" role="button" title="More info: &iexcl;Fiesta Latina!" aria-label="More info: &iexcl;Fiesta Latina!">Más Información</a></p>
						</div>
					</figure>
				</div>
			</div>
