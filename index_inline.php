        ...
        <div class="row card-row">
            ...
            <div class="col-md-6">
                <div class="box-item box" id="card_event1">
                    <figure class="front photo-front photo-front-shadow-topbottom" style="background-image:url('http://sprout018.sprout.yale.edu/AM-testing/peabody-homepage-refresh/img/cards/events_exhibitions/Patty_Gertenblith_eventcard_Feb_2018-mini.jpg'); background-position: center;">
                        <div class="front-content">
                            <h2 class="box-header">Afternoon Lecture</h2>
                            <h5 class="box-date box-date-right">Thursday, February 8th, 5 pm</h5>
                        </div>
                    </figure>
                    <figure class="back">
                        <div class="back-content">
                            <h5 class="box-header"><strong>Afternoon Lecture</strong></h5>
                            <h3 class="left plain-case mallory-thin exhibit-heading super-compress-h3" id="exhibit1_heading_back">Preserving Archaeological Heritage</h3>
                            <h5 class="left plain-case mallory-mp-light exhibit-subheading compress-h5" id="exhibit1_subheading_back">The Art Market, Museum Policies, and Conflict in the Middle East</h5>
                            <hr />
                            <p>In this lecture, Dr. Patty Gerstenblith explores the issues surrounding the looting, destruction, and preservation of archaeological sites in the Middle East.</p>
                            <p>Thursday, February 8th, 5 pm</p>
                            <p class="button-row"><a data-link-parent="card_event1" class="btn btn-peabody back-link" href="http://peabody.yale.edu/events/museum-talk/preserving-archaeological-heritage" role="button" title="More info: The Art Market, Museum Policies, and Conflict in the Middle East"
                                    aria-label="More info: The Art Market, Museum Policies, and Conflict in the Middle East">More Info</a></p>
                        </div>
                    </figure>
                </div>
            </div>
