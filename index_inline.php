        ...
        <div class="row card-row">
            ...
            <div class="col-md-6">
                <div class="box-item box" id="card_event1_alt">
                    <figure class="front photo-front photo-front-shadow-topbottom" style="background-image:url('http://sprout027.sprout.yale.edu/peabody-homepage-refresh/img/cards/events_exhibitions/JessicaGlassGallery_2018_webcard-mini.jpg'); background-position: left;">
                        <div class="front-content">
                            <h2 class="box-header">The Story of the Coelacanth</h2>
                            <h5 class="box-date box-date-right">Thursday, May 10, 4 pm</h5>
                        </div>
                    </figure>
                    <figure class="back">
                        <div class="back-content">
                            <h5 class="box-header"><strong>Gallery Talk</strong></h5>
                            <h3 class="left plain-case mallory-thin exhibit-heading" id="exhibit1_alt_heading_back">The Story of the Coelacanth</h3>
                            <h5 class="left plain-case mallory-mp-light exhibit-subheading" id="exhibit1_alt_subheading_back">An Ancient Fish Comes Alive</h5>
                            <hr/>
                            <p>Join us for our final gallery talk of the semester, as Jessica Glass shares the story of the coelacanth, an ancient fish that was believed to have gone extinct during the Cretaceous, yet still exists today.</p>
                            <p>Thursday, May 10, 4 pm</p>
                            <p class="button-row"><a data-link-parent="card_event1_alt" class="btn btn-peabody back-link" href="http://peabody.yale.edu/events/museum-talk/gallery-talk-story-coelacanth" role="button" title="More info: Gallery Talk with Jessica Glass" aria-label="More info: Gallery Talk with Jessica Glass">More Info</a></p>
                        </div>
                    </figure>
                </div>
            </div>
                ...
                <div class="box-item box" id="card_event2">
                    ...
                    <figure class="back">
                        <div class="back-content">
                            ...
                            <p class="button-row"><a data-link-parent="card_event2" class="btn btn-peabody back-link" href="http://peabody.yale.edu/events/night-peabody-museum" role="button" title="More info: A Night at the Peabody Museum" aria-label="More info: A Night at the Peabody Museum">More Info</a></p>
                        </div>
                    </figure>
                </div>
            </div>
